...
CREATE TABLE `ClinicalStaff` (
    ...
    `area` VARCHAR(80) NULL DEFAULT '',
    `type` VARCHAR(80) NULL DEFAULT '',
    `phone` VARCHAR(30) NULL DEFAULT '',
    `email` VARCHAR(254) NULL DEFAULT '',
    `gender` ENUM('MALE', 'FEMALE') NOT NULL DEFAULT 'MALE',
    `avatar` VARCHAR(200) NULL DEFAULT '',
    `address` VARCHAR(180) NULL DEFAULT '',
    ...
    `dependencias` VARCHAR(180) NULL DEFAULT '',
    `cargoNominal` VARCHAR(30) NULL DEFAULT '',
    `ubicacionFiscal` VARCHAR(180) NULL DEFAULT '',
